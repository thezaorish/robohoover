...
public class RoboHooverRequestValidatorTest {

	private RoboHooverRequestValidator validator;

	private RoboHooverRequest request;

	private BindingResult bindingResult;

	@Before
	public void setUp() {
		validator = new RoboHooverRequestValidator();
